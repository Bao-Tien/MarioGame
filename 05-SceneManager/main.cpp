...
#define BACKGROUND_COLOR_INTRO D3DXCOLOR(247.0f/255, 216.0f/255, 165.0f/255, 0.0f)
...
void Render()
{
	...
	if (dynamic_cast<CIntroScene*>(g->GetCurrentScene2())) {
		pD3DDevice->ClearRenderTargetView(pRenderTargetView, BACKGROUND_COLOR_INTRO);
	}
